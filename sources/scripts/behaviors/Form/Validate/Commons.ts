    ...
    validate: {
        methods: (validator) => {
            validator.addMethod(
                ...
                'O campo deve conter nome e sobrenome.'
            );
            ...
            validator.addMethod(
                ...
                'O arquivo deve ter menos de {0} MB.'
            );
            ...
            validator.addMethod(
                ...
                'O arquivo deve possuir a extensão {0}.'
            );
            ...
            validator.methodGroup('fullname', [{ rule: 'letters-only' }, { rule: 'complete-name' }, { rule: 'rangelength', param: [5, 75] }]);
        }
    }
};
